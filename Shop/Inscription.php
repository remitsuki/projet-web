        	...
        	<div class="panel panel-default">
        		<div class="panel-heading">
			    		...
			    		<form role="form" action="registerP.php" method="POST">
			                ...
			                <input type="text" name="first_name" id="firstname" class="form-control input-sm" placeholder="First Name" value="<?php echo (isset($_SESSION['firstname'])) ? $_SESSION['firstname'] : '' ?>" required>
			    					</div>
			    				</div>
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
